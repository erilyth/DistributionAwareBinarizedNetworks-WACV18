...
class ResNet(nn.Module):
    ...
    def forward(self, x):
        ...
        residual = out
        out = self.bn51(out)
        out = self.activ51(out)
        out = self.conv51(out)
        out = self.relu51(out)
        out = self.bn52(out)
        out = self.activ52(out)
        out = self.conv52(out)
        out += residual
        out = self.relu52(out)
        ...
        residual = out
        out = self.bn71(out)
        out = self.activ71(out)
        out = self.conv71(out)
        out = self.relu71(out)
        out = self.bn72(out)
        out = self.activ72(out)
        out = self.conv72(out)
        out += residual
        out = self.relu72(out)
        ...
        residual = out
        out = self.bn81(out)
        out = self.activ81(out)
        out = self.conv81(out)
        out = self.relu81(out)
        out = self.bn82(out)
        out = self.activ82(out)
        out = self.conv82(out)
        residual = self.bn83(residual)
        residual = self.activ83(residual)
